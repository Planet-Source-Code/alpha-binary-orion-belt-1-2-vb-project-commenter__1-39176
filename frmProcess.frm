...
'     Module Type: Form
'     Module Description: Contains commenting algorithm
'    ----------------------------------------------------------
'     © Copyright 2002
'    ----------------------------------------------------------
'   ============================================================
...
Private Sub CommentMain()
    ...
    = vbYes Then End 'Dunno, I've tried to unload every form manually but it stills hang out in my (computer's) memory
    Unload Me
    frmMain.Enabled = True
End Sub
                ...
                Open .sFileName For Output As #1
                    ...
                    If frmMain.chkComment(8).Value = 1 Or frmMain.chkComment(9).Value = 1 Then
                        For iLine = iLineToIns To UBound(sCode)
                            bChar = 0
                            sCurLine = LTrim$(sCode(iLine)) 'In case there're some spaces before the actual code
                    ...
                    If .mModType <> MProject Then
                        ...
                        Print #1, "'©opyright 2001-2002 by Alph@_Binary - All Right Reserved"
                    End If
                Close
            End If
        End With
