...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame fraProject 
      ...
      Begin VB.CheckBox chkComment 
         Appearance      =   0  'Flat
         BackColor       =   &H00C0FFFF&
         Caption         =   "Add application desctiptions to modules"
         ForeColor       =   &H80000008&
         Height          =   255
         Index           =   6
         Left            =   120
...
'     Module Type: Form
'     Module Description: Information input form
'    ----------------------------------------------------------
'     © Copyright 2002
'    ----------------------------------------------------------
'   ============================================================
...
Private Sub cmdBrowse_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If MsgBox("Project located. Begin commenting immediately?", vbYesNo + vbQuestion, "Proceeding with project file...") = vbYes Then cmdComment_MouseUp Button, Shift, X, Y
    Exit Sub
...
Private Sub cmdComment_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Dir$(sTargetProject) <> "" Then 'If the file exist then...
        If LCase$(Right(sTargetProject, 3)) = "vbp" Then 'If the file match the vb project extension then...
            Load frmProgress 'Start comment it!
            Me.Enabled = False
        Else
